...
describe('module elem-to-html', () => {
  ...
  const orderedElem1 = { type: 'list2-item', ordered: true, children: [{ text: '' }] }
  const orderedElem2 = { type: 'list2-item', ordered: true, children: [{ text: '' }] }
  const unOrderedItem1 = { type: 'list2-item', children: [{ text: '' }] }
  const unOrderedItem2 = { type: 'list2-item', children: [{ text: '' }] }
  const unOrderedItem21 = { type: 'list2-item', level: 1, children: [{ text: '' }] }
  ...
  test(`toHtml conf type`, () => {
    expect(listItemToHtmlConf.type).toBe('list2-item')
  })
