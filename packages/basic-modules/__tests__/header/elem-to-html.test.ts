...
describe('header - elem to html', () => {
  ...
  it('header1 to html', () => {
    ...
    const html = header1ToHtmlConf.elemToHtml(elem, 'hello', editor)
  ...
  it('header2 to html', () => {
    ...
    const html = header2ToHtmlConf.elemToHtml(elem, 'hello', editor)
  ...
  it('header3 to html', () => {
    ...
    const html = header3ToHtmlConf.elemToHtml(elem, 'hello', editor)
  ...
  it('header4 to html', () => {
    ...
    const html = header4ToHtmlConf.elemToHtml(elem, 'hello', editor)
  ...
  it('header5 to html', () => {
    ...
    const html = header5ToHtmlConf.elemToHtml(elem, 'hello', editor)
