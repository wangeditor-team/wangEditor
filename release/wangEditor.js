            ...
            if (type === 'click' && menu.onClick) {
                ...
                if (tooltip) {
                    $elem.on('mouseenter', function (e) {
                        ...
                        // 显示
                        tooltip.showTimeoutId = setTimeout(function () {
                            tooltip.show();
                        }, 200);
                    }).on('mouseleave', function (e) {
                        // 隐藏
                        tooltip.hideTimeoutId = setTimeout(function () {
                            tooltip.hide();
                        }, 0);
                    });
                }
