...
function tooltip(menu, opt) {
    ...
    this.opt = opt;
    // 容器
    var $container = $('<div class="w-e-tooltip"></div>');
        ...
        objForEach(menus, function (key, menu) {
            ...
            if (type === 'droplist' && droplist || tooltip && config$$1.tooltip) {
                ...
                $elem.on('mouseenter', function (e) {
                    ...
                    // 显示
                    hoverDiv.showTimeoutId = setTimeout(function () {
                        hoverDiv.show();
                    }, 200);
                }).on('mouseleave', function (e) {
                    // 隐藏
                    hoverDiv.hideTimeoutId = setTimeout(function () {
                        hoverDiv.hide();
                    }, 0);
                });
            }
