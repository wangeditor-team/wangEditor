...
class List extends DropListMenu implements MenuActive {
    ...
    private handleSelectionRangeNodes(listType: ListTypeValue): void {
        ...
        // 获取 序列标签
        const lsitTarget = listType.toLowerCase()
        ...
        // 创建一个 选区元素 对象，用来保存处理后需要设置选中的 元素
        const selectionRangeElem: SelectionRangeElem = new SelectionRangeElem()
        ...
        if (this.isOrderElem($selectionElem as DomElement)) {
            new ListHandleCommand(createListHandle(ClassType.wrap, options))
        }
        ...
        // =====================================
            ...
            new ListHandleCommand(createListHandle(ClassType.join, options))
        }
        ...
        // =====================================
            ...
            new ListHandleCommand(createListHandle(ClassType.startJoin, options))
        }
        ...
        // =====================================
            ...
            new ListHandleCommand(createListHandle(ClassType.endJoin, options))
        }
        ...
        // =====================================
            ...
            new ListHandleCommand(createListHandle(ClassType.other, options, _range as Range))
        }

        // 更新选区
        updateRange(editor, $(selectionRangeElem.get()), !!_collapsed)
    }
