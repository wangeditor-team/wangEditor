    ...
    E.plugin(function () {
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
            ...
            if (resultText.indexOf('error|') === 0) {
                ...
                typeof editor.config.preInertImg === 'function' &&
                    (resultText = editor.config.preInertImg(resultText));
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            // 跨域上传时，传 cookie
            // 上传到 upload.qiniu.com 会出现问题.
            config.withCredentials && (xhr.withCredentials = true);
